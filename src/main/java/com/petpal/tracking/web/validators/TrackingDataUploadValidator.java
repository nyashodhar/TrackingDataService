    ...
    private void validateAndGetTypeInformation(TrackingDataUpload trackingData, Errors errors) {
        ...
        for(String metricName : metricsData.keySet()) {
            ...
            if(!dataPointsForMetric.isEmpty()) {
                ...
                if(trackingMetricConfig.getAggregationDataType() == Long.class) {
                ...
                } else if(trackingMetricConfig.getAggregationDataType() == Double.class) {
                ...
                } else if(trackingMetricConfig.getAggregationDataType() == String.class) {
