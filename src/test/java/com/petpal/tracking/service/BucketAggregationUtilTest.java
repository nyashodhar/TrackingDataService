...
public class BucketAggregationUtilTest {
    ...
    //
    // convertRawToUTCAggregated()
    //

    @Test
    public void testConvertRawToUTCAggregated_null_aggregated_data() {

        TrackingMetricConfig trackingMetricConfig =
                new TrackingMetricConfig("something", Long.class, Long.class, Aggregation.SUM);

        TreeMap aggregatedData = bucketAggregationUtil.convertRawToUTCAggregated(
    ...
    @Test
    public void testConvertRawToUTCAggregated_empty_aggregated_data() {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testConvertRawToUTCAggregated_timezone_missing() {
        ...
        bucketAggregationUtil.convertRawToUTCAggregated(
                trackingMetricConfig, unaggregatedData, null, AggregationLevel.MONTHS);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testConvertRawToUTCAggregated_bucketsize_missing() {
        ...
        unaggregatedData.put(1L, 1L);
        bucketAggregationUtil.convertRawToUTCAggregated(trackingMetricConfig, unaggregatedData, timeZonePST, null);
    }

    @Test
    public void testConvertRawToUTCAggregated_years_with_gap() {
        ...
        TreeMap<Long, Long> aggregatedData = bucketAggregationUtil.convertRawToUTCAggregated(
    ...
    @Test
    public void testConvertRawToUTCAggregated_months_with_gap() {
    ...
    @Test
    public void testConvertRawToUTCAggregated_weeks_with_gap() {
    ...
    @Test
    public void testConvertRawToUTCAggregated_days_with_gap() {
    ...
    @Test
    public void testConvertRawToUTCAggregated_hours_with_gap() {
